...
angular.module('toasty', ['ngAnimate'])
    ...
    .constant('toastyConfig', {
        ...
        'clickToClose': true, // enable disable click to close.
        ...
        'position': 'toasty-top-middle',
        'sound': false, // enable sounds by default
        'icon-classes': {
            error: 'toasty-error',
            info: 'toasty-info',
            wait: 'toasty-wait',
    ...
    .directive('toastyContainer', ['$compile', '$timeout', '$sce', 'toastyConfig', 'toasty',
        function($compile, $timeout, $sce, toastyConfig, toasty) {
            ...
            return {
                ...
                template: '<div id="toasty-container" style="display: block !important; z-index:2000 !important;" ng-class="config.position">' +
                    ...
                    '<button ng-click="closeClick(toasty)" class="toasty-close-button pull-right" >&times;</button>' +
    ...
    .controller('toasty-controller', ['$scope', 'toasty', '$window', function($scope, toasty, $window) {
