...
.directive('ngDatepicker', ['$document','datePickerSvc', function($document,datePickerSvc) {
	'use strict';
	...
	return {
		...
		link: function (scope, element, attrs, ngModel) {
			...
			if (scope.startDate)
				datePickerSvc.setStartDateScope(scope);
			else if (scope.endDate)
				datePickerSvc.setEndDateScope(scope);
		...
		'<div class="ng-datepicker" id= "datePicker" ng-show="calendarOpened">' +
		'  <div class="controls">' +
		'    <div class="left">' +
